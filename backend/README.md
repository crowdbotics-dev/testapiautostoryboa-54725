...
## Project Structure
    ...
    ├── testapiautostoryboa_54725  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_54725`
...
2. Clone this repo and `cd testapiautostoryboa_54725`
